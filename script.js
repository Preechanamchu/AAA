document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        th: {
            ...
            manageCategoriesTitle: "จัดการหมวดหมู่", manageCoinPackagesTitle: "เติมเหรียญ", manageDiamondPassTitle: "เพชร & Pass", categoryNameLabel: "ชื่อหมวดหมู่", categoryNameEnLabel: "ชื่อหมวดหมู่ (English)", categoryIconLabel: "ไอค่อนหมวดหมู่", minOrderLabel: "จำนวนสั่งซื้อขั้นต่ำ",
        ...
        en: {
            ...
            manageCategoriesTitle: "Manage Categories", manageCoinPackagesTitle: "Add Coins", manageDiamondPassTitle: "Diamond & Pass", categoryNameLabel: "Category Name", categoryNameEnLabel: "Category Name (English)", categoryIconLabel: "Category Icon", minOrderLabel: "Minimum Order Quantity",
        ...
        for (const productId in appData.cart) {
            ...
            if (quantity > 0) {
                ...
                if (product) {
                    ...
                    if (product.isCoin || product.isDiamond || product.isFarmPass) grandTotalPrice += (product.price * quantity);
                }
            }
        }
    ...
    let catalogPage = 0; // 0=products, 1=coins, 2=diamond/pass
    let swapRotation = 0;
    document.getElementById('swap-catalog-btn').addEventListener('click', function() {
        catalogPage = (catalogPage + 1) % 3;
        ...
        if (productGrid) {
            ...
            setTimeout(() => {
                if (catalogPage === 1 || catalogPage === 2) {
