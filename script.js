    ...
    const ManagerStore = (() => {
        ...
        function rejectRegistration(id) {
            ...
            .then(data => {
                ...
                if (confirmedIndex !== -1) {
                    ...
                    // ไม่ใช้ splice เพื่อให้ข้อมูลยังคงอยู่ใน storeRegistrations และแสดงผลในแท็บปฏิเสธได้
                }
        ...
        function renderStoreRegistrations() {
            ...
            if (approvedTbody) {
                ...
                }).join('') || '<tr><td colspan="5" class="ms-empty-state">📭 ยังไม่มีร้านค้าที่อนุมัติ</td></tr>';
            ...
            if (rejectedTbody) {
                ...
                }).join('') || '<tr><td colspan="5" class="ms-empty-state">📭 ยังไม่มีร้านค้าที่ไม่อนุมัติ</td></tr>';
