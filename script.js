document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('registration-form').addEventListener('submit', async (e) => {
        ...
        const formData = {
            ...
            packageType: 'standard', // Removed selection, defaulting to standard
    ...
    const ManagerStore = (() => {
        ...
        function renderStoreRegistrations() {
            ...
            `;
            }).join('') || '<tr><td colspan="4" class="ms-empty-state">📭 ไม่มีร้านค้ารอดำเนินการ</td></tr>';
        ...
        function renderRegistrationsHistory() {
            ...
            `).join('') || `<tr><td colspan="5" class="ms-empty-state">📭 ไม่มีประวัติ${mode === 'approved' ? 'ที่อนุมัติ' : 'ที่ถูกปฏิเสธ'}</td></tr>`;
        }
        ...
        function renderPendingSerialKeyStores(stores) {
            ...
            `;
            }).join('') || '<tr><td colspan="4" class="ms-empty-state">📭 ไม่มีร้านค้ารอใส่ Serial Key</td></tr>';
        ...
        function renderPendingStores() {
            ...
            `;
            }).join('') || '<tr><td colspan="4" class="ms-empty-state">🏪 ไม่มีร้านค้าพร้อมเปิด</td></tr>';
        ...
        function renderActiveStores() {
            ...
            if (container) {
                container.innerHTML = activeStores.map(store => {
                    ...
                    `;
                }).join('') || '<tr><td colspan="6" class="ms-empty-state">🏪 ไม่มีร้านค้าที่เปิดใช้งาน</td></tr>';
            }
        ...
        function updatePackages(newPackages) {
            // Updated: Package UI updates removed
